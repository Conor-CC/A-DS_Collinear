...
class Collinear
{
     ...
     *  Explanation: TODO
     */
    public static final int A_ONE_Y_POINT = 1;
    public static final int A_TWO_Y_POINT = 2;
    public static final int A_THREE_Y_POINT = 3;
        ...
        for (int i = 0; i < a1.length; i++) {
            for (int j = 0; j < a2.length; j++) {
                for (int k = 0; k < a3.length; k++) {
                      if ((a1[i]*(A_TWO_Y_POINT - A_THREE_Y_POINT) + a2[j]*(A_THREE_Y_POINT - A_ONE_Y_POINT) + a3[k]*(A_ONE_Y_POINT - A_TWO_Y_POINT)) == 0) {
                          count++;
                      }
                }
            }
