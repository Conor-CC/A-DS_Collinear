...
public class CollinearTest
{
    ...
    public static void main(String[] args)
    {
        ...
        In a1 = new In("r04000-1.txt");
        In a2 = new In("r04000-2.txt");
        In a3 = new In("r04000-3.txt");
        int[] pointsOne = a1.readAllInts();
        int[] pointsTwo = a2.readAllInts();
        int[] pointsThree  = a3.readAllInts();
        Stopwatch stopwatch = new Stopwatch();
        int result = Collinear.countCollinear(pointsOne, pointsTwo, pointsThree);
        System.out.println(stopwatch.elapsedTime());
        System.out.println("Collinear Triples: " + result);
    }
